...
const cssInjectFunction = '(function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");d.head[a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));})';
